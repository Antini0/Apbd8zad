...
namespace Exercise6
{
    public static class LinqTasks
    {
        ...
        {
            IEnumerable<Emp> result = Emps.Where(e => e.Job.Equals("Frontend programmer")).Where(e => e.Salary > 1000)
        ...
        public static IEnumerable<object> Task10()
        {
            IEnumerable<object> result = Emps.Select(emp => new { emp.Ename, emp.Job, emp.HireDate })
                .Union(Emps
                    .Select(emp => new { Ename = "Brak wartości", Job = (string)null, HireDate = (DateTime?)null }));
            return result;
        }
        ...
        public static IEnumerable<Dept> Task14()
        {
            IEnumerable<Dept> result = Depts.GroupJoin(Emps,
                    ...
                    (d, e) => new
                    {
                        d = d,
                        eCount = e.Count()
                    }).Where(group => group.eCount == 5 || group.eCount == 0)
                .OrderBy(x => x.d.Dname)
                .Select(x => x.d);
            //result =
            return result;
    ...
    public static class CustomExtensionMethods
    {
        ...
        public static IEnumerable<Emp> GetEmployeesWithSubordinates(this IEnumerable<Emp> employees)
        {
            return employees
                .Where(emp => employees.Any(subordinate => subordinate.Mgr == emp))
                .OrderBy(emp => emp.Ename)
                .ThenByDescending(emp => emp.Salary);
        }

        public static int FindOdd(this int[] numbers)
        {
